            ...
            <div class="block-content block-content-full">
                ...
                <div class="row gutters-tiny js-gallery img-fluid-100">
                    ...
                    <div class="col-md-1 col-lg-1 animated fadeIn push">
                        <a class="img-link img-link-zoom-in img-lightbox" id="{{str_replace("
                            ,","",str_replace(" ", "", $filesKey)).$key}}" href="/uploads/{{$file->getFileName()}}">
                            <div class="options-container">
                                ...
                                <div class="options-overlay bg-black-75">
                                    <div class="options-overlay-content">
                                        <a class="btn btn-sm btn-primary btn-view" data-id="{{str_replace("
                                            ,","",str_replace(" ", "", $filesKey)).$key}}" href="javascript:void(0)">
